                        ...
                        <TableBody>
                            {
                                list.map((element, i) => {
                                    return (
                                        <TableRow
                                            key={element.id + "key" + element.ip_addr}
                                            sx={{ '&:last-child td, &:last-child th': { border: 0 } }}
                                        >
                                            <TableCell key={element.id + "key" + element.ip_addr + data.user.placeholder} component="th" scope="row">{element.id}</TableCell>
                                            <TableCell align="left">{element.ip_addr}</TableCell>
