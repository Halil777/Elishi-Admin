...
function SubCategory() {
  ...
  const getData = () => {
    AxiosInstance.get('/sub-category/get-sub-category?category_id=' + selectCategory)
      .then(response => {
        if (!response.data.error) {
  ...
  return (
    <div>
      ...
      >
        ...
        <SubCategoryTable getData={getData} list={list} isEmpty={isEmpty} categoryList={categoryList} />
      </Stack>
